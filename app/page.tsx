  ...
  return (
    <>
      ...
      <div 
        ...
        style={{ backgroundImage: "url('/bg-plane.jpg')" }}
      >
        ...
        <div className="relative z-10 container mx-auto px-6 pt-32 pb-20">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-white/80 max-w-2xl mx-auto">
              Experience unparalleled comfort aboard New Zealand's premier private airline
            </p>
          </div>
            ...
            <div className="bg-white rounded-2xl shadow-2xl overflow-hidden">
              ...
              <div className="flex border-b border-gray-100">
                ...
                <button
                  ...
                  className={`flex-1 py-4 font-semibold transition-all relative ${
                    activeTab === "cancel" ? "text-blue-600" : "text-gray-500 hover:text-gray-700"
                  }`}
                >
              ...
              <div className="p-6 md:p-8">
                ...
                {activeTab === "search" && (
                  <form onSubmit={searchFlights}>
                      ...
                      <div>
                        ...
                        <div className="relative">
                          ...
                          <select
                            ...
                            className="w-full pl-9 pr-3 py-2.5 border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 bg-gray-50 text-gray-800 text-sm"
                            required
                          >
                            <option value="" className="text-gray-500">Select city</option>
                            {airports.map((airport) => (
                              <option key={airport.code} value={airport.code} className="text-gray-800">
                    ...
                    <button
                      type="submit"
                      disabled={loading}
                      className="w-full mt-6 bg-gradient-to-r from-blue-600 to-indigo-600 text-white font-semibold py-3 rounded-xl hover:from-blue-700 hover:to-indigo-700 transition-all disabled:opacity-50 flex items-center justify-center gap-2 text-sm"
                    >
                    ...
                    <form onSubmit={fetchMyBookings}>
                      <div className="flex gap-3">
                        <div className="flex-1 relative">
                          ...
                          <input
                            type="email"
                            value={myBookingsEmail}
                            onChange={(e) => setMyBookingsEmail(e.target.value)}
                            placeholder="Enter your email"
                            className="w-full pl-9 pr-3 py-2.5 border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 bg-gray-50 text-gray-800 text-sm placeholder-gray-400"
                            required
                          />
                        </div>
                        <button
                          ...
                          className="bg-gradient-to-r from-purple-600 to-pink-600 text-white font-semibold px-6 py-2.5 rounded-xl hover:from-purple-700 hover:to-pink-700 transition-all flex items-center gap-2 text-sm"
                        >
                        ...
                        {myBookings.length > 0 && (
                          <>
                                  ...
                                  <div className="flex justify-between items-start flex-wrap gap-3">
                                    <div>
                                      ...
                                      <div className="flex items-center gap-3">
                                        <div>
                                          <p className="text-xl font-bold text-gray-800">{booking.flight.origin}</p>
                                          <p className="text-xs text-gray-500">{formatTimeOnly(booking.flight.departureDateTime)}</p>
                                        </div>
                                        <ArrowRightIcon className="w-3 h-3 text-gray-400" />
                                        <div>
                                          <p className="text-xl font-bold text-gray-800">{booking.flight.destination}</p>
                                          <p className="text-xs text-gray-500">{formatTimeOnly(booking.flight.arrivalDateTime)}</p>
                                        </div>
                                      </div>
                                      <p className="text-xs text-gray-400 mt-2">{formatDate(booking.flight.departureDateTime)}</p>
                                    </div>
                                    <div className="text-right">
                                      <p className="text-xl font-bold text-blue-600">${booking.flight.price}</p>
                                    </div>
                                  </div>
                                </div>
                              ))}
                            ...
                            <button
                              ...
                              className="mt-3 text-gray-400 hover:text-gray-600 text-sm transition"
                            >
                              Close
                            </button>
                          </>
                ...
                {activeTab === "cancel" && (
                  <form onSubmit={handleCancelBooking}>
                    <div className="space-y-4">
                      <div>
                        ...
                        <input
                          ...
                          className="w-full px-3 py-2.5 border border-gray-200 rounded-xl focus:ring-2 focus:ring-red-500 bg-gray-50 text-gray-800 text-sm uppercase"
                          required
                        />
                      </div>
                      <div>
                        ...
                        <div className="relative">
                          ...
                          <input
                            ...
                            className="w-full pl-9 pr-3 py-2.5 border border-gray-200 rounded-xl focus:ring-2 focus:ring-red-500 bg-gray-50 text-gray-800 text-sm"
                            required
                          />
                        </div>
                      </div>
                    ...
                    <button
                      ...
                      className="w-full mt-5 bg-gradient-to-r from-red-600 to-red-700 text-white font-semibold py-2.5 rounded-xl hover:from-red-700 hover:to-red-800 transition-all disabled:opacity-50 text-sm"
                    >
                ...
                {cancelError && activeTab === "cancel" && (
                  <div className="mt-4 p-3 bg-red-50 border border-red-200 rounded-xl text-red-600 text-sm">
                    {cancelError}
                  </div>
                )}
                {cancelMessage && activeTab === "cancel" && (
          ...
          {/* Flight Results - New Design with Arrow */}
          {flights.length > 0 && activeTab === "search" && (
            <div className="max-w-4xl mx-auto mt-8">
              ...
              <div className="space-y-3">
                {flights.map((flight) => (
                  <div key={flight.id} className="bg-white rounded-xl p-5 shadow-md hover:shadow-lg transition group">
                    <div className="flex flex-wrap items-center justify-between gap-4">
                      {/* Left side - Route with Arrow */}
                      <div className="flex-1">
                        {/* Flight number and aircraft */}
                        <div className="flex items-center gap-2 mb-3">
                          <span className="text-xs font-mono font-bold text-blue-600">{flight.flightNumber}</span>
                          <span className="text-gray-300 text-xs">|</span>
                          <span className="text-xs text-gray-500">{flight.aircraft}</span>
                          {flight.availableSeats <= 2 && flight.availableSeats > 0 && (
                            <span className="bg-orange-100 text-orange-700 text-xs px-2 py-0.5 rounded-full ml-2">
                        ...
                        <div className="flex items-center gap-4">
                          ...
                          <div className="min-w-[100px]">
                            <p className="text-2xl font-bold text-gray-800">{formatTimeOnly(flight.departureDateTime)}</p>
                            <p className="text-sm font-semibold text-gray-700">{getCityName(flight.origin)}</p>
                          ...
                          <div className="flex flex-col items-center flex-1 min-w-[60px]">
                            ...
                            <p className="text-xs text-gray-400 mt-1">
                              {Math.round((new Date(flight.arrivalDateTime).getTime() - new Date(flight.departureDateTime).getTime()) / 60000)} min
                            </p>
                          </div>
                          
                          {/* Arrival */}
                          <div className="min-w-[100px]">
                            <p className="text-2xl font-bold text-gray-800">{formatTimeOnly(flight.arrivalDateTime)}</p>
                            <p className="text-sm font-semibold text-gray-700">{getCityName(flight.destination)}</p>
                            <p className="text-xs text-gray-400">{flight.destination}</p>
                          </div>
                        </div>
                        
                        {/* Date */}
                        <p className="text-xs text-gray-400 mt-3">{formatDate(flight.departureDateTime)}</p>
                      </div>
                      ...
                      <div className="text-right min-w-[120px]">
                        ...
                        <button
                          ...
                          className={`mt-2 px-5 py-2 rounded-lg text-sm font-semibold transition-all flex items-center gap-1 ${
      ...
      <footer className="bg-gray-900 text-white py-8">
        <div className="container mx-auto px-6 text-center text-gray-500 text-sm">
          <p>© 2026 Dairy Flat Airlines. All rights reserved.</p>
        </div>
      </footer>
